...
class MoveMouse:
    ...
    def auto_click(self, end_time=None) -> None:
        ...
        while self.run:
            ...
            if (
                current_mouse_x >= int(self.screen_width * 0.75)
                or current_mouse_x < 100
            ):
                x_start = self.screen_width / 2
                y_start = self.screen_height / 2
            if (
                current_mouse_y >= int(self.screen_height * 0.75)
                or current_mouse_y < 100
            ):
                x_start = self.screen_width / 2
                y_start = self.screen_height / 2
            pyautogui.moveTo(x_start, y_start)
